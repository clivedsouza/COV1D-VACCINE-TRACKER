...
class MainActivitykt : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                Toast.makeText(this@MainActivitykt, "Please enter a valid pin code", Toast.LENGTH_SHORT)
                    .show()
            } else {
    ...
    private fun getAppointments(pinCode: String, date: String) {
        ...
        val queue = Volley.newRequestQueue(this@MainActivitykt)
        ...
        val request =
            ...
            JsonObjectRequest(Request.Method.GET, url, null, { response ->
                ...
                { error ->
                    ...
                    Toast.makeText(this@MainActivitykt, "Failed to get response", Toast.LENGTH_SHORT)
                        .show()
                })
